...
class OrganisationAccountOpeningAddApprovedRequestActionHandlerTest {

    @InjectMocks
    private OrganisationAccountOpeningAddApprovedRequestActionHandler addAcceptedRequestActionHandler;
    ...
    void execute() {
        ...
        addAcceptedRequestActionHandler.execute(execution);
