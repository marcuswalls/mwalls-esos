...
class OrganisationAccountOpeningSendApprovalEmailServiceTest {
    ...
    void sendEmail() {
        ...
        assertThat(emailData.getNotificationTemplateData().getTemplateName()).isEqualTo(NotificationTemplateName.ACCOUNT_APPLICATION_APPROVED);
