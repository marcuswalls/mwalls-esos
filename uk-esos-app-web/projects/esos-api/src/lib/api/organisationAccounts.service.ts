...
export class OrganisationAccountsService {
   ...
   */
  public getCurrentUserOrganisationAccounts(
    page: number,
    size: number,
    term?: string,
  ...
  public getCurrentUserOrganisationAccounts(
    ...
    if (page === null || page === undefined) {
      throw new Error('Required parameter page was null or undefined when calling getCurrentUserOrganisationAccounts.');
    }
    if (size === null || size === undefined) {
      throw new Error('Required parameter size was null or undefined when calling getCurrentUserOrganisationAccounts.');
    }
    ...
    return this.httpClient.get<AccountSearchResults>(`${this.configuration.basePath}/v1.0/organisation/accounts`, {
