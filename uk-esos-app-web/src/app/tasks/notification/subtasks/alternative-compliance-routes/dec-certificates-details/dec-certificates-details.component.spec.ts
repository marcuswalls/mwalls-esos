...
import { DecCertificatesDetailsComponent } from './dec-certificates-details.component';

describe('DecCertificatesDetailsComponent', () => {
  let component: DecCertificatesDetailsComponent;
  let fixture: ComponentFixture<DecCertificatesDetailsComponent>;
  let page: Page;
  ...
  class Page extends BasePage<DecCertificatesDetailsComponent> {
  ...
  const createComponent = () => {
    fixture = TestBed.createComponent(DecCertificatesDetailsComponent);
  ...
  describe('for new dec certificates details details', () => {
    beforeEach(() => {
    ...
    it('should display all HTMLElements and form with 0 errors', () => {
      ...
      expect(page.heading1.textContent.trim()).toEqual(alternativeComplianceRoutesMap.decCertificatesDetails.title);
    ...
    it('should submit a valid form and navigate to nextRoute', () => {
      ...
      expect(page.errorSummaryListContents).toEqual([
        ...
        'Enter a Display Energy Certificate number',
        'Enter a date',
        'Enter a date',
      ]);
  ...
  describe('for existing dec certificates details details', () => {
    beforeEach(() => {
      store = TestBed.inject(RequestTaskStore);
      store.setState(
        mockStateBuild(
    ...
    it('should display all HTMLElements and form with 0 errors', () => {
      ...
      expect(page.heading1).toBeTruthy();
      expect(page.heading1.textContent.trim()).toEqual(alternativeComplianceRoutesMap.decCertificatesDetails.title);
      expect(page.certificateNumber1).toEqual('dec1');
      ...
      expect(page.certificateNumber2).toEqual('dec2');
