...
import { SecondaryContactDetailsComponent } from './secondary-contact-details.component';

describe('ContactPersonsSecondaryDetailsComponent', () => {
  let component: SecondaryContactDetailsComponent;
  let fixture: ComponentFixture<SecondaryContactDetailsComponent>;
  ...
  class Page extends BasePage<SecondaryContactDetailsComponent> {
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(SecondaryContactDetailsComponent);
  ...
  it('should submit and navigate to next route', () => {
    ...
    expect(taskServiceSpy).toHaveBeenCalledWith({
      ...
      currentStep: 'secondaryContact',
      route,
      payload: {
        noc: {
          contactPersons: {
            ...mockContactPersons,
            secondaryContact: { ...mockContactPersons.secondaryContact, email: 'johndoe@mail.com' },
          } as ContactPersons,
        },
        nocSectionsCompleted: { contactPersons: 'IN_PROGRESS' },
      },
