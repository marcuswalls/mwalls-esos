...
public class UserOtpService {
    ...
    private void validateUserOtp(String otp, UserModel user) {
        OTPCredentialProvider credentialProvider = (OTPCredentialProvider) session.getProvider(CredentialProvider.class,
                "keycloak-otp");
        ...
        if (!otpValid) {
            // Users should be disabled when multiple incorrect 2FA codes are attempted in
            // succession.
            ...
            // If a valid 2FA code has subsequently been entered within the allowed
            // incorrect count range,
